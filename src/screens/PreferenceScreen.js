...
const PreferenceScreen = (props) => {
    ...
    const [data, setData] = useState({
        preference:menuDetailedData[props.route.params.index].preferenceData,
        required:menuDetailedData[props.route.params.index].required,
        minimum_quantity :menuDetailedData[props.route.params.index].minimum_quatity,
    })
                        ...
                        data.preference.map(item => 
                            <View key = {item.id}>
                                <View style = {styles.view7}>
                                    <Text style = {styles.text8}>{menuDetailedData[index].preferenceTitle[data.preference.indexOf(item)]}</Text>
                                    {
                                        data.required[data.preference.indexOf(item)] && 
                                        <View style = {styles.view9}>
                                            <Text style = {styles.text7}>{data.minimum_quantity[data.preference.indexOf(item)]} REQUIRED</Text>
                                        </View>
                                    }
                                </View>
